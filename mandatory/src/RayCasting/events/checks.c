...
/*   Updated: 2023/11/16 18:20:59 by hamaarou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// if (x < 0 || y < 0 || x >= mlx->cub3d.map.x * TILE_SIZE
	// 	|| y >= mlx->cub3d.map.y * TILE_SIZE)
	// 	return (1);
	...
	if (mlx->cub3d.map_2d[(int)((y - 2) / TILE_SIZE)][(int)(x
			/ TILE_SIZE)] == '1' || mlx->cub3d.map_2d[(int)((y - 2) / TILE_SIZE)][(int)(x / TILE_SIZE)] == '$')
		return (1);
	if (mlx->cub3d.map_2d[(int)((y + 2) / TILE_SIZE)][(int)(x
			/ TILE_SIZE)] == '1' || mlx->cub3d.map_2d[(int)((y + 2) / TILE_SIZE)][(int)(x / TILE_SIZE)] == '$')
		return (1);
	if (mlx->cub3d.map_2d[(int)(y / TILE_SIZE)][(int)((x - 2)
			/ TILE_SIZE)] == '1' || mlx->cub3d.map_2d[(int)(y / TILE_SIZE)][(int)((x - 2) / TILE_SIZE)] == '$')
		return (1);
	if (mlx->cub3d.map_2d[(int)(y / TILE_SIZE)][(int)((x + 2)
			/ TILE_SIZE)] == '1' || mlx->cub3d.map_2d[(int)(y / TILE_SIZE)][(int)((x + 2) / TILE_SIZE)] == '$')
		return (1);
